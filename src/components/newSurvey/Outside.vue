<template>
  <div>
	...
	<div class="receiver-field">
			...
			<div class="control">
				<div class="select" v-model="bondtype">
					<select>
						...
						<option>Corner Clamp</option>
						<option>Trailer Clamp</option>
					</select>
				</div>
			</div>
		</div>
		...
		<h4 class="is-size-4">Voltage at Ground Block</h4>
    ...
    <a class="button is-info" @click>Submit</a>
     </div>
   </div>
</template>
